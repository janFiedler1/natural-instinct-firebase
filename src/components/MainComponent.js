...
function Main (){
    const pieces = [{id: 1, title: 'Rockets Shorts', measurements: ['Medium', '19.5 Inches'], description: 'Made from a pair of used vintage pants and a vintage James Harden Houston Rockets Jersey. Back welt pockets included.', path: process.env.PUBLIC_URL+'/rockets-shorts-enhanced.png', type: "bottom", payment_link:"https://buy.stripe.com/cN2bKtcR415b4jSbII", price: 60.00, status: "available", images: [process.env.PUBLIC_URL+'/top-icon.jpg']},
        ...
        {id: 4, title: 'Yin Yang Longsleeve', measurements: ['Medium', '24 Inches','22 Inches'], description: 'Made from two Adidas Long sleeves.', path: process.env.PUBLIC_URL+'/no-light-longsleeve.png', type: "top", payment_link:"https://buy.stripe.com/4gw5m54ky4hneYw6or", price: 70.00, status: "available", images: [process.env.PUBLIC_URL+'/top-icon.jpg']},
        {id: 5, title: 'White Sox Jersey', measurements: ['Medium', '27 Inches'], description: 'Made from vintage Chicago White Sox Jersey and parts of a flannel.', path: process.env.PUBLIC_URL+'/white-sox-front.jpg', type: "top", payment_link:"https://buy.stripe.com/6oE5m54kyaFL4jSaEI", price: 35.00, status: "available", images: [process.env.PUBLIC_URL+'/top-icon.jpg']},
        {id: 6, title: 'Calvin & Hobbes Hoodie', measurements: ['Medium', '24.5 Inches','24 Inches'], description: 'Made from two vintage Ontario Basketball Hoodies. Front pockets included', path: process.env.PUBLIC_URL+'/calvin-hobbs-front.jpg', type: "top", payment_link:"https://buy.stripe.com/9AQbKtg3gaFL03CdQS", price: 85.00, status: "available", images: [process.env.PUBLIC_URL+'/top-icon.jpg']},
        {id: 7, title: 'D Wade Shorts', measurements: ['Small', '16.5 Inches'], description: 'Made from Vintage Miami Heat Dwayne Wade Jersey. Side Seam Pockets and back pocket. Basketball Mesh added on.', path: process.env.PUBLIC_URL+'/dwade-shorts-front.jpg', type: "bottom", payment_link:"https://buy.stripe.com/fZe8yh18m7tzaIg3ch", price: 60.00, status: "available", images: [process.env.PUBLIC_URL+'/top-icon.jpg']},
     ]
