...
function Main (){
    ...
    const pieces = [
        {id: 1, 
            ...
            path: process.env.PUBLIC_URL+'/rockets-shorts-enhanced.png', 
            type: "bottoms", 
        ...
        {id: 2, 
            ...
            path: process.env.PUBLIC_URL+'/earth-first-longsleeve.png', 
            type: "tops", 
            payment_link:"", 
            price: 200.00, 
            status: "sold", 
        ...
        {id: 3, 
            ...
            path: process.env.PUBLIC_URL+'/give-me-space-longsleeve.png', 
            type: "tops", 
        ...
        {id: 4, 
            ...
            path: process.env.PUBLIC_URL+'/no-light-longsleeve.png', 
            type: "tops", 
